            ...
            <div id="{{ $dropdownId }}" class="absolute left-0 mt-2  w-48 z-50 hidden rounded-lg bg-white shadow-lg dark:bg-gray-700">
              <ul class="p-2 text-left text-sm font-medium text-gray-500 dark:text-gray-400">
                <form action="{{ route('order.reorder', $order) }}" method="POST">
                  @csrf
                  <button type="submit" class="w-full group flex items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                ...
                <li>
                  ...
                  <a  href="{{ route('order.detail', ['first_name' => auth()->user()->first_name, 'invoice_number' => $order->invoice_number]) }}" class="group flex items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                    <svg class="me-1.5 h-4 w-4 text-gray-400 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
