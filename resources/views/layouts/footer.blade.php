...
<footer class="bg-gray-100 mx-auto  max-w-screen dark:bg-gray-800 pt-4">
    <div class=" mx-auto max-w-screen-2xl w-full py-6 lg:py-8">
      <div class="grid grid-cols-2 gap-8 sm:grid-cols-2 lg:grid-cols-4">
        <div class="mb-2 -mt-7 flex items-start">
          <a href="#" class="flex items-center">
            <img src="{{ asset('img/component/LogoJH.png') }}" class="h-40 me-3 filter brightness-75 hover:brightness-125 dark:hover:brightness-150" alt="Jims Honey Pati" />
          </a>
        </div>
        <div>
