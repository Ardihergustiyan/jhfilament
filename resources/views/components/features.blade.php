...
<div class="container mx-auto px-4 p-6">
    <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-6">
      <div class="card flex items-start p-4 border-0">
        <div class="text-dark w-8 h-8 flex-shrink-0">
          <!-- Icon -->
        ...
        <div class="ml-4">
          <h5 class="font-semibold text-lg">Free delivery</h5>
          <p class="text-gray-500 text-sm">Lorem ipsum dolor sit amet, consectetur adipi elit.</p>
        </div>
      </div>
      ...
      <div class="card flex items-start p-4 border-0">
        ...
        <div class="ml-4">
          <h5 class="font-semibold text-lg">100% secure payment</h5>
          <p class="text-gray-500 text-sm">Lorem ipsum dolor sit amet, consectetur adipi elit.</p>
        </div>
      </div>
      <div class="card flex items-start p-4 border-0">
