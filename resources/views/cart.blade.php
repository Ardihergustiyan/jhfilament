                            ...
                            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                ...
                                <div class="flex items-center justify-between md:order-3 md:justify-end">
                                    <div class="flex items-center">
                                        ...
                                        <input type="text" id="counter-input-{{ $item->id }}" data-input-counter data-item-id="{{ $item->id }}" data-price="{{ $item->product->het_price }}"  class="w-10 shrink-0 border-0 bg-transparent text-center text-sm font-medium text-gray-900 focus:outline-none focus:ring-0 dark:text-white" value="{{ $item->quantity }}" required />
                                    ...
                                    <div class="text-end md:order-4 md:w-32">
                                        <p class="text-base font-bold text-gray-900 dark:text-white">Rp{{ number_format($item->product->het_price, 0, ',', '.') }}</p>
                                    </div>
                                </div>
